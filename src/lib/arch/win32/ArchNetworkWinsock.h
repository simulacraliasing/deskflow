...
public:
  ...
  size_t readDatagram(ArchSocket s, void *buf, size_t len, ArchNetAddress *source) override;
  size_t writeDatagram(ArchSocket s, const void *buf, size_t len, ArchNetAddress destination) override;
